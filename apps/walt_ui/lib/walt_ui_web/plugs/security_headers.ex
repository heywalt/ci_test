defmodule WaltUiWeb.Plug.SecurityHeaders do
  @moduledoc """
  ...
  (see WaltUiWeb.CowboyNoServerHeader) since it's added at the HTTP adapter level.
  ...
  @secure_cookies Application.compile_env(:walt_ui, :secure_cookies, false)
  ...
  defp put_hsts_header(conn) do
    ...
    # includeSubDomains = apply to all subdomains (e.g., app.heywalt.ai, www.heywalt.ai)
