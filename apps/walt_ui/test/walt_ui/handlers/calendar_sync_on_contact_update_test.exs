defmodule WaltUi.Handlers.CalendarSyncOnContactUpdateTest do
  ...
  alias WaltUi.Handlers.CalendarSyncOnContactUpdate
  ...
  describe "handle/2" do
    test "enqueues calendar sync job when email field changes" do
      Oban.Testing.with_testing_mode(:manual, fn ->
        ...
        assert :ok = CalendarSyncOnContactUpdate.handle(event, metadata)
    ...
    test "enqueues calendar sync job when emails field changes" do
      Oban.Testing.with_testing_mode(:manual, fn ->
        user_id = Ecto.UUID.generate()
        contact_id = Ecto.UUID.generate()
        external_account_id = Ecto.UUID.generate()
